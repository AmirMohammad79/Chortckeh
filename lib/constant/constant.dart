...
// const kPrimeryColor = Color.fromRGBO(143, 148, 251, 1);
const kPrimaryColor =  Color(0xff26a69a);
const kSecondaryColor=  Color(0xFF80cbc4);
const kThirdColor=  Color(0xff00838f);
const kFourthColor=  Color(0xff64b5f6);
const kFifthColor=  Color(0xffb39ddb);
...
const kThiridTextStyle =  TextStyle(color: kTextColor,
    fontSize: 20
    ,fontWeight: FontWeight.w700 ,
fontFamily: kVazirFont);
